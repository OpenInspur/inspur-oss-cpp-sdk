...
std::string InspurCloud::OSS::GenerateUuid()
{
    return "";
}

std::string InspurCloud::OSS::UrlEncode(const std::string & src)
{
...
std::string InspurCloud::OSS::UrlDecode(const std::string & src)
{
...
std::string InspurCloud::OSS::Base64Encode(const std::string &src)
{
    return InspurCloud::OSS::Base64Encode(src.c_str(), static_cast<int>(src.size()));
}

std::string InspurCloud::OSS::Base64Encode(const char *src, int len)
{
    if (!src || len == 0) {
        return "";
    }
...
std::string InspurCloud::OSS::Base64EncodeUrlSafe(const std::string &src)
{
    return InspurCloud::OSS::Base64EncodeUrlSafe(src.c_str(), static_cast<int>(src.size()));
}

std::string InspurCloud::OSS::Base64EncodeUrlSafe(const char *src, int len)
{
    std::string out = InspurCloud::OSS::Base64Encode(src, len);
...
std::string InspurCloud::OSS::ComputeContentMD5(const std::string& data) 
{
    return ComputeContentMD5(data.c_str(), data.size());
}

std::string InspurCloud::OSS::ComputeContentMD5(const char * data, size_t size)
{
    if (!data) {
        return "";
    }
...
std::string InspurCloud::OSS::ComputeContentMD5(std::istream& stream) 
{
...
std::string InspurCloud::OSS::ComputeMD5(const std::string& data)
{
	return ComputeMD5(data.c_str(), data.size());
}

std::string InspurCloud::OSS::ComputeMD5(const char* data, size_t size)
{
	if (!data) {
		return "";
	}
	...
	return std::string(reinterpret_cast<char*>(md), MD5_DIGEST_LENGTH);
}
...
std::string InspurCloud::OSS::ComputeContentETag(const std::string& data)
{
    return ComputeContentETag(data.c_str(), data.size());
}

std::string InspurCloud::OSS::ComputeContentETag(const char * data, size_t size)
{
    if (!data) {
        return "";
    }
...
std::string InspurCloud::OSS::ComputeContentETag(std::istream& stream)
{
    auto ctx = EVP_MD_CTX_create();
...
void InspurCloud::OSS::StringReplace(std::string & src, const std::string & s1, const std::string & s2)
{
...
std::string InspurCloud::OSS::LeftTrim(const char* source)
{
...
std::string InspurCloud::OSS::RightTrim(const char* source)
{
    std::string copy(source);
...
std::string InspurCloud::OSS::Trim(const char* source)
{
    return LeftTrim(RightTrim(source).c_str());
}

std::string InspurCloud::OSS::LeftTrimQuotes(const char* source)
{
    std::string copy(source);
...
std::string InspurCloud::OSS::RightTrimQuotes(const char* source)
{
    std::string copy(source);
...
std::string InspurCloud::OSS::TrimQuotes(const char* source)
{
    return LeftTrimQuotes(RightTrimQuotes(source).c_str());
}

std::string InspurCloud::OSS::ToLower(const char* source)
{
    std::string copy;
    if (source) {
...
std::string InspurCloud::OSS::ToUpper(const char* source)
{
    std::string copy;
    if (source) {
        size_t srcLength = strlen(source);
...
bool InspurCloud::OSS::IsIp(const std::string &host)
{
...
std::string InspurCloud::OSS::ToGmtTime(std::time_t &t)
{
...
std::string InspurCloud::OSS::ToUtcTime(std::time_t &t)
{
    std::stringstream date;
    std::tm tm;
#ifdef _WIN32
...
std::time_t InspurCloud::OSS::UtcToUnixTime(const std::string &t)
{
...
bool InspurCloud::OSS::IsValidBucketName(const std::string &bucketName)
{
#if defined(__GNUG__) && __GNUC__ < 5
 ...
 bool InspurCloud::OSS::IsValidObjectKey(const std::string & key)
{
 ...
 bool InspurCloud::OSS::IsValidLoggingPrefix(const std::string &prefix)
 {
     if (prefix.empty())
         return true;
#if defined(__GNUG__) && __GNUC__ < 5
 ...
 bool InspurCloud::OSS::IsValidChannelName(const std::string &channelName)
 {
 ...
 bool InspurCloud::OSS::IsValidPlayListName(const std::string &playlistName)
 {
 ...
 bool InspurCloud::OSS::IsValidTagKey(const std::string &key)
 {
 ...
 bool InspurCloud::OSS::IsValidTagValue(const std::string &value)
 {
     return value.size() <= TagValueLengthLimit;
 }

const std::string& InspurCloud::OSS::LookupMimeType(const std::string &name)
{
...
std::string InspurCloud::OSS::CombineHostString(
...
std::string InspurCloud::OSS::CombinePathString(
    const std::string &endpoint,
    const std::string &bucket,
...
std::string InspurCloud::OSS::CombineRTMPString(
    const std::string &endpoint, 
    const std::string &bucket,
    bool isCname)
{
...
std::string InspurCloud::OSS::CombineQueryString(const ParameterCollection &parameters)
{
    std::stringstream ss;
    if (!parameters.empty()) {
...
std::streampos InspurCloud::OSS::GetIOStreamLength(std::iostream &stream)
{
    auto currentPos = stream.tellg();
    if (currentPos == static_cast<std::streampos>(-1)) {
        currentPos = 0;
...
const char *InspurCloud::OSS::ToStorageClassName(StorageClass storageClass)
{
    static const char *StorageClassName[] = { "Standard", "IA", "Archive" };
    return StorageClassName[storageClass - StorageClass::Standard];
}

StorageClass InspurCloud::OSS::ToStorageClassType(const char *name)
{
...
const char *InspurCloud::OSS::ToAclName(CannedAccessControlList acl)
{
...
CannedAccessControlList InspurCloud::OSS::ToAclType(const char *name)
{
...
const char *InspurCloud::OSS::ToCopyActionName(CopyActionList action)
{
    static const char *ActionName[] = { "COPY", "REPLACE"};
    return ActionName[action - CopyActionList::Copy];
}

const char *InspurCloud::OSS::ToRuleStatusName(RuleStatus status)
{
    static const char *StatusName[] = { "Enabled", "Disabled" };
    return StatusName[status - RuleStatus::Enabled];
}

RuleStatus InspurCloud::OSS::ToRuleStatusType(const char *name)
{
...
const char *InspurCloud::OSS::ToLiveChannelStatusName(LiveChannelStatus status)
{
...
LiveChannelStatus InspurCloud::OSS::ToLiveChannelStatusType(const char *name)
{
    std::string statusName = ToLower(name);
...
const char* InspurCloud::OSS::ToRequestPayerName(RequestPayer payer)
{
...
RequestPayer InspurCloud::OSS::ToRequestPayer(const char* name)
{
    std::string statusName = ToLower(name);
...
const char* InspurCloud::OSS::ToSSEAlgorithmName(SSEAlgorithm sse)
{
    static const char* StatusName[] = { "NotSet", "KMS", "AES256", "C-AES256"};
    return StatusName[static_cast<int>(sse) - static_cast<int>(SSEAlgorithm::NotSet)];
}

SSEAlgorithm InspurCloud::OSS::ToSSEAlgorithm(const char* name)
{
    std::string statusName = ToLower(name);
    if (!statusName.compare("kms")) return SSEAlgorithm::KMS;
    else if (!statusName.compare("aes256")) return SSEAlgorithm::AES256;
    else if (!statusName.compare("c-aes256")) return SSEAlgorithm::CustomerAES256;
