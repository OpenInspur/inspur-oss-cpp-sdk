...
void OssResumableBaseRequest::setRequestPayer(InspurCloud::OSS::RequestPayer value)
{
    requestPayer_ = value;
}

InspurCloud::OSS::RequestPayer OssResumableBaseRequest::RequestPayer() const
{
